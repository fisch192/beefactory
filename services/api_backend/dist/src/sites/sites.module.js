...
const sites_controller_js_1 = require("./sites.controller.js");
let SitesModule = class SitesModule {
};
exports.SitesModule = SitesModule;
exports.SitesModule = SitesModule = __decorate([
    (0, common_1.Module)({
        controllers: [sites_controller_js_1.SitesController],
        providers: [sites_service_js_1.SitesService],
        exports: [sites_service_js_1.SitesService],
    })
], SitesModule);
