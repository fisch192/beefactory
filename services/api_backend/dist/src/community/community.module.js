...
exports.CommunityModule = CommunityModule = __decorate([
    (0, common_1.Module)({
        controllers: [community_controller_js_1.CommunityController],
        providers: [community_service_js_1.CommunityService],
        exports: [community_service_js_1.CommunityService],
    })
], CommunityModule);
