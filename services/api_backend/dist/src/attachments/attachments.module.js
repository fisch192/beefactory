...
const attachments_controller_js_1 = require("./attachments.controller.js");
...
exports.AttachmentsModule = AttachmentsModule = __decorate([
    (0, common_1.Module)({
        controllers: [attachments_controller_js_1.AttachmentsController],
        providers: [attachments_service_js_1.AttachmentsService],
        exports: [attachments_service_js_1.AttachmentsService],
    })
], AttachmentsModule);
