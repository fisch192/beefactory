...
const zones_controller_js_1 = require("./zones.controller.js");
let ZonesModule = class ZonesModule {
};
exports.ZonesModule = ZonesModule;
exports.ZonesModule = ZonesModule = __decorate([
    (0, common_1.Module)({
        controllers: [zones_controller_js_1.ZonesController],
        providers: [zones_service_js_1.ZonesService],
        exports: [zones_service_js_1.ZonesService],
    })
], ZonesModule);
